...
const polarTrips = [
  {
    image: "/advrs-bess.png",
    title: "Nadia Bess",
    description:
      "A traveler obsessed with going to increasingly remote locations.",
  },
  {
  ...
  {
    image: "/advrs-melissa.png",
    title: "Melissa Elliott",
    description:
      "Adventure seeker who loves unique hotels and exploring off-the-beaten-path.",
  },
  {
    image: "/advrs-alex.png",
    title: "Alexandra Farrington",
    description:
      "That friend that used all her PTO to take one long trip and never came back.",
  },
  {
    image: "/advrs-mei-mei.png",
    title: "Mei-Mei Kirk",
    description:
      "I’m a retired media exec who has been passionately exploring the world for the past decade and helping others find their way.",
  },
  {
    image: "/advrs-perry.png",
    title: "Mark Perry",
    description:
      "I am willing to go almost anywhere, and try any adventure when the opportunity presents itself.",
  },
];

export default function PolarAdvisor() {
