...
const destinations = [
  ...
  { name: "Saudi Arabia", img: "/arabia.png" },
  { name: "Israel", img: "/isreal.png" },
  { name: "Oman", img: "/oman.png" },
  { name: "United Arab Emirates (UAE)", img: "/uae.png" },
  { name: "Jordan", img: "/jordan2.png" },
  { name: "Qatar", img: "/qatar.png" },
];

export default function TopMiddleEast() {
