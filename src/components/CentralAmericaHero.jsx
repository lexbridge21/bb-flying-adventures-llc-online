      ...
      <div className="w-full md:w-1/2 bg-[#f3ebdf] flex items-center justify-center px-6 md:px-12 py-10 text-center md:text-left">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-800 max-w-md mx-auto md:mx-0">
            A bucket list full of travel adventures, from surfing in Costa Rica
            to hiking ancient ruins in Guatemala. And everything is closer than
            you think thanks to ever-expanding direct flights from US hubs.
            Vamonos!
          </p>
        </div>
      </div>
...
export default CentralAmericaHero;
