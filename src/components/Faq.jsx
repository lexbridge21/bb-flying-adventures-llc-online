...
export default function Faq() {
  ...
  return (
    <>
      <div className="mx-15 border-t border-gray-300"></div>

      <section className="px-6 py-12 md:px-16 lg:px-24 max-w-5xl mx-auto">
          ...
          {faqs.map((faq, index) => (
            <div key={index}>
              <button
                ...
                className="w-full flex justify-between items-center py-4 text-left lg:text-2xl text-lg font-chiswick focus:outline-none"
              >
                {faq.question}
                {openIndex === index ? (
