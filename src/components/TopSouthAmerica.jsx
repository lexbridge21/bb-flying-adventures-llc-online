...
const destinations = [
  { name: "Argentina", img: "/aurgnt.png" },
  { name: "Chile", img: "/chile.png" },
  { name: "Peru", img: "/peru.png" },
  { name: "Bolivia", img: "/bolivia.png" },
  { name: "Colombia", img: "/columb.png" },
  { name: "Uruguay", img: "/urguary.png" },
  { name: "Brazil", img: "/brazil.png" },
  { name: "Ecuador", img: "/ecuda.png" },
];

export default function TopSouthAmerica() {
